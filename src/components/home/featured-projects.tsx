...
export function FeaturedProjects() {
  ...
  const featuredProjects = [
     projects.find(p => p.id === "portfolio"),    
     projects.find(p => p.id === "ytspeed"),
    projects.find(p => p.id === "imagegenerator"),
        ...
        <ScrollReveal delay={0.2} width="100%">
          ...
          >
            ...
            <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
              A selection of my recent work showcasing Full-stack development and DevOps
            </p>
          </motion.div>
        </ScrollReveal>
